...
void MainWidget::initMainWidget()
{
    ...
    menu_extend_bt_->setStyleSheet(ConfigHelper::GetQssString(":/camera_menu/res/css/narrow_button.css"));

    int id = QFontDatabase::addApplicationFont(":/camera_menu/res/fonts/Font Awesome 6 Duotone-Solid-900.otf");
