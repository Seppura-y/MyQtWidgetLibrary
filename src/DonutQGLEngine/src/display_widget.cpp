	...
	: QWidget(parent)
{
	...
	this->setStyleSheet(ConfigHelper::GetQssString(":/main_widget/res/css/display_widget.css"));
}
...
{
	int id = QFontDatabase::addApplicationFont(":/main_widget/res/fonts/Font Awesome 6 Pro-Light-300.otf");
	if (id < 0)
