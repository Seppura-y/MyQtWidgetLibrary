...
DialogContentTabBase::DialogContentTabBase(QWidget* parent) : QWidget(parent)
{
    this->setStyleSheet(ConfigHelper::GetInstance()->GetQssString(":screen_capture_dialog/res/css/dialog_content.css"));
}

void DialogContentTabBase::paintEvent(QPaintEvent* ev)
{
    QStyleOption option;
    option.init(this);
...
FileTab::FileTab(QWidget* parent) : DialogContentTabBase(parent)
{
...
CaptureTab::CaptureTab(int tab_index, QWidget* parent, capture_type type) : DialogContentTabBase(parent), cap_type_(type)
{
...
DesktopTab::DesktopTab(int tab_index, QWidget* parent, capture_type type) : DialogContentTabBase(parent)
{
    tab_index_ = tab_index;
    ui.setupUi(this);
